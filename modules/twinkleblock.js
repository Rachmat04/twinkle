...
Twinkle.block = function twinkleblock() {
	...
	if ( Morebits.userIsInGroup('sysop') && mw.config.get('wgRelevantUserName') ) {
		Twinkle.addPortletLink(Twinkle.block.callback, 'Block', 'tw-block', 'Blokir pengguna' );
	}
};

Twinkle.block.callback = function twinkleblockCallback() {
	if( mw.config.get('wgRelevantUserName') === mw.config.get('wgUserName') &&
			!confirm( 'Anda akan memblokir diri sendiri! Apakah Anda ingin melanjutkan?' ) ) {
		return;
	}
	...
	Window.addFooterLink( 'Templat blokir', 'Template:Uw-block/doc/Block_templates' );
	...
	if ($form.find('[name=actiontype][value=block]').is(':checked')) {
		...
		var blockoptions = [
				...
				},
				{
					...
					label: 'Blokir pengguna mengirimkan surel',
					name: 'noemail',
					value: '1'
				},
				{
					checked: Twinkle.block.field_block_options.disabletalk,
					label: 'Hindarkan pengguna ini untuk menyunting halaman pembicaraan penggunanya ketika sedang diblokir',
					name: 'disabletalk',
					value: '1'
				}
			];
		...
		if (Twinkle.block.isRegistered) {
			blockoptions.push({
					...
					label: 'Blokir otomatis alamat IP yang digunakan (hardblock)',
					name: 'autoblock',
					value: '1'
				});
		} else {
			blockoptions.push({
					...
					label: 'Cegah pengguna yang masuk log untuk menyunting dari alamat IP ini (hardblock)',
					name: 'hardblock',
					value: '1'
				});
		}
		...
		field_block_options.append({
				type: 'textarea',
				label: 'Alasan (untuk log pemblokiran):',
				name: 'reason',
...
Twinkle.block.blockPresetsInfo = {
	...
	'uw-ablock' : {
		...
		pageParam: true,
		reasonParam: true,
		summary: 'Alamat IP Anda diblokir dari penyuntingan',
	...
	'uw-aeblock' : {
		...
		reasonParam: true,
		summary: 'Anda diblokir karena melanggar kebijakan arbitrase dengan suntingan Anda'
	},
	'uw-bioblock' : {
		autoblock: true,
		nocreate: true,
	...
	'uw-block' : {
		...
		pageParam: true,
		reasonParam: true,
		summary: 'Anda telah diblokir dari penyuntingan',
		suppressArticleInSummary: true
	},
	'uw-blockindef' : {
		autoblock: true,
		...
		pageParam: true,
		reasonParam: true,
		summary: 'Anda telah diblokir dari penyuntingan selamanya',
		suppressArticleInSummary: true
	},
	'uw-blocknotalk' : {
		disabletalk: true,
		pageParam: true,
		reasonParam: true,
		summary: 'Anda telah diblokir dari penyuntingan dan akses ke halaman pembicaraan pengguna sudah dimatikan',
		suppressArticleInSummary: true
	},
	'uw-botblock': {
		forRegisteredOnly: true,
		...
		summary: 'Anda diblokir karena menjalankan kode bot sebelum mendapatkan persetujuan'
	},
	'uw-botublock': {
		expiry: 'infinity',
		forRegisteredOnly: true,
		reason: 'Nama pengguna mirip dengan nama bot (softblock)',
	...
	'uw-causeblock' : {
		expiry: 'infinity',
		forRegisteredOnly: true,
		reason: 'Nama pengguna terkesan berhubungan dengan nama organisasi (softblock)',
	...
	'uw-compblock': {
		...
		summary: 'Anda diblokir selamanya karena akun ini dianggap telah disalahgunakan'
	},
	'uw-copyrightblock' : {
		autoblock: true,
		expiry: '24 hours',
	...
	'uw-ipevadeblock' : {
		...
		summary: 'Alamat IP Anda diblokir karena digunakan untuk menhindari pemblokiran sebelumnya'
	},
	'uw-lblock' : {
		autoblock: true,
		expiry: 'infinity',
	...
	'uw-memorialblock': {
		forRegisteredOnly: true,
		expiry: 'infinity',
		reason: 'Nama pengguna terkesan sebagai penghormatan kepada seseorang (softblock)',
	...
	'uw-pablock' : {
		...
		expiry: '31 hours',
		nocreate: true,
		reason: 'Serangan atau olokan terhadap subjek',
		summary: 'Anda diblokir karena menyerang pengguna lainnya'
	},
	'uw-sblock' : {
		autoblock: true,
		nocreate: true,
		reason: 'Menggunakan Wikipedia untuk menyebarkan spam',
		summary: 'Anda diblokir karena mengirimkan spam'
	},
	'uw-soablock' : {
		autoblock: true,
		expiry: 'infinity',
	...
	'uw-softerblock' : {
		expiry: 'infinity',
		forRegisteredOnly: true,
		reason: 'Nama pengguna untuk promosi (softblock)',
	...
	'uw-ublock' : {
		expiry: 'infinity',
		forRegisteredOnly: true,
		reason: 'Nama pengguna dilarang (softblock)',
		reasonParam: true,
	...
	'uw-ublock-double': {
		expiry: 'infinity',
		forRegisteredOnly: true,
		reason: 'Nama pengguna mirip dengan pengguna lain (softblock)',
	...
	'uw-uhblock' : {
		...
		forRegisteredOnly: true,
		nocreate: true,
		reason: 'Nama pengguna dilarang (hardblock)',
		reasonParam: true,
	...
	'uw-ublock-famous' : {
		expiry: 'infinity',
		forRegisteredOnly: true,
		reason: 'Nama pengguna mirip tokoh terkenal (hardblock)',
	...
	'uw-uhblock-double': {
		...
		forRegisteredOnly: true,
		nocreate: true,
		reason: 'Nama pengguna mirip dengan pengguna lain (hardblock)',
	...
	'uw-vblock' : {
		...
		summary: 'Anda diblokir karena melakukan [[WP:VANDAL|vandalisme]]'
	},
	'uw-voablock' : {
		autoblock: true,
		expiry: 'infinity',
		...
		summary: 'Anda diblokir selamanya karena melakukan vandalisme semata-mata'
	}
};
...
Twinkle.block.blockGroups = [
	...
	},
	{
		...
		list: [
			...
			{ label: 'Nama pengguna promosi, hard block', value: 'uw-spamublock' },
			{ label: 'Nama pengguna promosi, soft block', value: 'uw-softerblock' },
			{ label: 'Nama pengguna yang mirip, soft block', value: 'uw-ublock-double' },
			{ label: 'Pelanggaran nama pengguna, soft block', value: 'uw-ublock' },
			{ label: 'Pelanggaran nama pengguna, hard block', value: 'uw-uhblock' },
			{ label: 'Nama pengguna meniru-niru, hard block', value: 'uw-uhblock-double' },
			{ label: 'Nama pengguna yang mewakili tokoh terkenal, soft block', value: 'uw-ublock-famous' },
			{ label: 'Nama pengguna yang mewakili organisasi, soft block', value: 'uw-causeblock' },
			{ label: 'Pelanggaran nama pengguna, akun spam semata-mata', value: 'uw-vaublock' }
		]
	},
	{
...
Twinkle.block.callback.evaluate = function twinkleblockCallbackEvaluate(e) {
	...
	if (toBlock) {
		if (!blockoptions.expiry) return alert('Berikan waktu kedaluwarsa!');
		...
		api.getToken('block').then(function(token) {
			statusElement.status('Menjalankan...');
...
Twinkle.block.callback.main = function twinkleblockcallbackMain( pageobj ) {
	...
	if ( Twinkle.getPref('blankTalkpageOnIndefBlock') && params.template !== 'uw-lblock' && params.indefinite ) {
		...
		Morebits.status.info( 'Info', 'Akan membuat bagian tingkat 2 baru untuk tanggal, karena bulan ini tidak tersedia' );
		text += '== ' + date.getUTCMonthName() + ' ' + date.getUTCFullYear() + ' ==\n';
	}
